package ab.strukturierte_programmierung.verzweigungen.abPlus.s_bahn;
...
import static util.NicoMath.charToInt;
import static util.NumberFormatter.formatToCurrency;
